...
var app = new Vue({
    ...
    created: function () {
        ...
        if (!sessionStorage.getItem('membersJSON')) {
            ...
            this.getData();
        } else if (sessionStorage.getItem('membersJSON') && (new Date(sessionStorage.getItem('fetch_time_controller')) < new Date())) {
            this.fetching_time = new Date();
            this.fetching_time_controller = new Date();
            this.fetching_time_controller.setMinutes(this.fetching_time.getMinutes() + 1);
            sessionStorage.setItem('fetch_time_controller', this.fetching_time_controller);
            ...
            this.members = Array.from(JSON.parse(sessionStorage.getItem('membersJSON')));
            this.loading = false;
